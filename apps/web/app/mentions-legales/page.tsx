    ...
    <main className="mx-auto max-w-4xl space-y-8 px-6 py-10">
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm leading-relaxed">
          <p>
            Immatout est un <strong>outil de simulation indicatif</strong>. Les montants affichés ne
            constituent pas un devis opposable à l&apos;administration. Le montant exact de votre
            carte grise ne peut être confirmé que par les services de l&apos;État via le portail
            officiel <code>ants.gouv.fr</code>.
          </p>
          <p>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm">
          <p>
            ...
            <code>@immatout/calc</code>) et les barèmes (<code>@immatout/data</code>) sont librement
            auditables.
          </p>
          <p>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm">
          <ul className="list-disc space-y-1 pl-5">
            <li>
              Grilles CO₂ <strong>2020-2023</strong> non ingérées : les imports d&apos;occasion dont
              la 1ère immatriculation est antérieure à 2024 utilisent en fallback la grille 2024
              (valeur conservatrice, documentée dans le champ <code>scaleYear</code> du résultat).
            </li>
            <li>
